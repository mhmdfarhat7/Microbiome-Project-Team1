      ...
      >
        ...
        >
          {data.metadata?.location
            ? `🌍 ${data.metadata.location} - Microbial Composition`
            : kind === "pie"
        ...
        >
          {data.labels?.length || 0} different{" "}
          {data.labels?.length === 1 ? "organism" : "organisms"} found
          {data.metadata?.n_runs && ` • ${data.metadata.n_runs} bioruns`}
        </p>
      </div>
